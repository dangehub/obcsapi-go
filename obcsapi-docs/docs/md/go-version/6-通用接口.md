...
示例动作 [Obcsapi_20230607_121411.json](https://github.com/dangehub/obcsapi-go/blob/master/obcsapi-docs/docs/json/Obcsapi_20230607_121411.json) 功能是保存文字，导入后需要编辑动作设置好服务器地址和请求头。然后即可使用。
